...
yrate=zeros(1,3);
yrate(1)=(r+1)^6-1;    % annual interest rate;
...
yrate(2)=(r+1)^6-1;    % annual interest rate;
...
yrate(3)=(r+1)^6-1;    % annual interest rate;
clearvars -EXCEPT yrate;
...
figure(1);
plot(amins,yrate,'b')
title('annual interest rate versus amins')
xlabel('amin')
